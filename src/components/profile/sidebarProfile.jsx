        ...
        <Box style={{ position: 'relative' }}>
            ...
            <Box sx={{
                ...
                <List sx={{ color: "#000", width: "max-content" }}>
                    <Typography variant="h6" style={{ fontSize: "30px", marginBottom: 20 }}>Hola, {user.name.split(" ")[0]}</Typography>
                    <Typography variant="h6" style={{ fontSize: "18px", marginBottom: 20 }}>Administrar mi cuenta</Typography>
                    ...
                    <Typography variant="h6" style={{ fontSize: "18px", marginBottom: 20 }}>Mis órdenes</Typography>
                    <Box sx={{ ml: 4, mt: 2 }}>
